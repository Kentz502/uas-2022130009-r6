...
use App\Http\Controllers\RSIXController;
...
Route::get('/', RSIXController::class);
...
Route::get('/operator/{operator}/show', [OperatorController::class, 'show'])->name('operators.show');
...
Route::get('/weapon/{weapon}/show', [WeaponController::class, 'show'])->name('weapons.show');
...
Route::get('/map/{map}/show', [MapController::class, 'show'])->name('maps.show');
...
Route::get('/playerstat/{playerstat}/show', [PlayerStatController::class, 'show'])->name('playerstats.show');
...
Route::get('/tournament/index', [App\Http\Controllers\TournamentController::class, 'index'])->name('tournaments.index');
Route::put('/tournament/{tournament}/update', [TournamentController::class, 'update'])->name('tournaments.update');
...
Route::get('/tournament/{tournament}/show', [TournamentController::class, 'show'])->name('tournaments.show');
Route::get('/tournament/{tournament}/edit', [TournamentController::class, 'edit'])->name('tournaments.edit');
Route::delete('/tournament/{tournament}/destroy', [TournamentController::class, 'destroy'])->name('tournaments.destroy');
